...
import useful_functions_frames as uf
import argparse
import math

def main():
	# Add argument parser for easy command line use
	parser = argparse.ArgumentParser(description="Main file for solving frame structure")
	...
	eles = uf.create_eles(args.folder_path+"/elements.txt",nodes,three_dim=False)
